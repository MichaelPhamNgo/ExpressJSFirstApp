...
router.post('/', (req, res) => {
    ...
    if(first && last && username && email && password) {
        ...
        db.none("INSERT INTO Authentications(FirstName, LastName, Username, Email, Password, Salt) VALUES ($1, $2, $3, $4, $5, $6)", params)
            .then(() => {
                //We successfully added the user, let the user know
                res.send({
                    success: true
                });
                sendEmail("trashcan891@gmail.com", email, "Welcome!", "<strong>Welcome to our app!</strong>");
            }).catch((err) => {
            //log the error
            console.log(err);
